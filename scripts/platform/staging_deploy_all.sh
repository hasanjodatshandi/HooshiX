...
for service in compromised-password-service notification-service authorization-service identity-service conversation-service web-bff; do "$ROOT/scripts/platform/staging_deploy_service.sh" "$service"; done
