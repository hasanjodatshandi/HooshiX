...
def main():
    ...
    for rel in ['authorization-fingerprint/fingerprint.properties','authorization-quota-key/quota.properties','identity-fingerprint/fingerprint.properties','identity-challenge/challenge.properties','identity-handoff/handoff.properties','identity-quota/quota.properties','identity-refresh/refresh.properties','notification-fingerprint/fingerprint.properties','notification-delivery/delivery.properties','web-bff-locator/locator.properties','web-bff-csrf/csrf.properties','web-bff-refresh/refresh.properties']:
        ring(rel)
