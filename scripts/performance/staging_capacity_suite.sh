...
workloads=(
  --kubernetes-namespace platform-apps
  --kubernetes-deployment authorization-service
  --kubernetes-deployment compromised-password-service
  --kubernetes-deployment identity-service
  --kubernetes-deployment notification-service
  --kubernetes-deployment web-bff
)
