...
public final class ConversationErasureReceiptDispatcher {
  ...
  public ConversationErasureReceiptDispatcher(
      DSLContext dsl,
    ...
    this.clock = clock;
    this.topic = topic;
    this.published = meters.counter("conversation.erasure.receipt_outbox.published");
    this.failures = meters.counter("conversation.erasure.receipt_outbox.failures");
  }

  @Scheduled(fixedDelayString = "${conversation.erasure-receipt-dispatch-delay:PT1S}")
