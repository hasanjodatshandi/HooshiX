...
public final class AuthorizationException extends RuntimeException {
  ...
  public AuthorizationException(AuthorizationError error, String message) {
    super(message);
    this.error = error;
  }

  public AuthorizationException(AuthorizationError error, String message, Throwable cause) {
    super(message, cause);
    this.error = error;
  }
