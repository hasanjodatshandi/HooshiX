...
public final class NotificationErasureListener {
  private final JooqNotificationErasureRepository repository;
  private final TransactionTemplate transactions;
  private final Clock clock;

  public NotificationErasureListener(
  ...
  @KafkaListener(
      topics = "${notification.erasure-command-topic:hooshix.identity.erasure.command.v1}",
      groupId = "${notification.erasure-consumer-group:hooshix-notification-erasure-v1}",
