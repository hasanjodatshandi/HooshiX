...
def main():
    ...
    require(text,r"IDENTITY_ERASURE_RUNTIME_ENABLED","erasure runtime gate missing")
    require(text,r'secretName: "identity-kafka"',"Kafka connection Secret missing")
    require(text,r"identity-kafka","Kafka egress missing")
