...
def main():
    ...
    require(text, r"WEB_BFF_ERASURE_RUNTIME_ENABLED", "erasure runtime gate missing")
    require(text, r'secretName: "web-bff-kafka"', "Kafka connection Secret missing")
    require(text, r"web-bff-kafka", "Kafka egress missing")
    require(text, r"name: migrate", "migration init container missing")
    require(text, r'secretName: "web-bff-db-runtime"', "runtime database Secret missing")
    require(text, r'secretName: "web-bff-db-migration"', "migration database Secret missing")
