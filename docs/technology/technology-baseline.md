...
| Vulnerability correlation | Grype 0.117.0 | ADR-0035/0038/0045; final-image/SBOM findings + owned exceptions; scanner/feed freshness is release authority |
...
- blocking source/secret checks and final-artifact SBOM/vulnerability/signing/provenance gates under ADR-0045;
...
- Gitleaks 8.30.1 native release artifact, Syft 1.51.0, Grype 0.117.0, Cosign 3.0.6, and other downloaded security tools verify exact checksums/digests/signatures as applicable before use;
