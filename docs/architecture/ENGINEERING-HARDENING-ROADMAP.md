...
| 5 | Dependency, DevSecOps, and frontend release alignment | `IN PROGRESS` | Replace dynamic manifest versions with reviewed pins, align React types/runtime and Protobuf compiler, add distinct JS advisory/SAST gates, and include the frontend in immutable image/SBOM/Grype/Cosign/Kyverno release evidence. | Implementation started from `main@c6a972d2d770ddb8a50b48dc57630856d2920597`; completion review and protected evidence pending |
