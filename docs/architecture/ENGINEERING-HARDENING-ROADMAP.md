...
| 2 | Database deadlines and durable-worker lease safety | `IN PROGRESS` | Define operation-specific transaction/statement/lock budgets; implement cancellation/error mapping; add lock contention/pool-exhaustion tests; measure and enforce worker batch/deadline/lease invariants without layered retries or remote I/O in transactions. | Implementation started from `main@04a986a626f8447f56c3f4e328fff7b2bf6f63b6`; completion verification pending |
