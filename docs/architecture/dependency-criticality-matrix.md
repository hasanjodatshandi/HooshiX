...
| `notification.result-callback-dispatch` | Notification | Identity `ReportNotificationResult` | `DURABLE_COMMAND` | result outbox remains pending | Notification durable callback dispatcher | none | Notification | ADR-0029; `services/notification-service.md` §14 |
