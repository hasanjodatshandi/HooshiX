...
| `web-bff.google-oidc-login` | Web BFF | Google OIDC endpoints | `AUTHORITATIVE_SECURITY` | login unavailable | protocol-defined safe flow only | no alternate identity auto-link | Web BFF | ADR-0016; `services/web-bff.md` §5 |
