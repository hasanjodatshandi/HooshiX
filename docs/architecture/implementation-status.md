...
| --- | --- | --- | --- | --- | --- |
| Identity Service | DESIGNED | IMPLEMENTED registration vertical slice | repository service/persistence/registration-security/quota/handoff/deployment CI VERIFIED on `main@9642507`; deployed runtime and wider ADR-0012 Identity surface NOT VERIFIED | NOT VERIFIED | `services/identity-service` |
...
| Identity registration CI/architecture/security/migration/quota/deployment gates | DESIGNED | IMPLEMENTED | local Java 25/WSL verification passed unit/integration/architecture/SpotBugs/Spotless/bootJar including PostgreSQL/Flyway and Redis Testcontainers; local Buf, Semgrep, Gitleaks, Helm render/hardening, and repository baseline gates passed; protected merged-main Identity execution passed Gitleaks, OSV, strict Gradle verification, unit/integration/architecture/SpotBugs, Buf, Semgrep, Helm, Prometheus/dashboard, runtime-image, generated-file, and baseline gates on `main@9642507`; deployed-runtime evidence remains NOT VERIFIED |
