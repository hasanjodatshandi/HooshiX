...
| Conversation Service | DESIGNED under ADR-0054/0057 | PARTIAL: executable service, authority, CRUD/history, ModelRun/cost, lifecycle/erasure, and BFF/browser slices IMPLEMENTED; provider activation slice pending | Local evidence covers exact-audience JWT, one-attempt Authorization, validated gRPC/OpenAPI, ownership/RLS/encryption, reservation/replay/cancellation, bounded worker/provider, conservative ambiguity and reconciliation, ordered lifecycle/erasure, exact BFF workload routing, and browser polling/text rendering. Governance and cluster egress keep provider execution disabled; provider safety/evaluation/telemetry and transport cancellation, activation/release, and deployed runtime remain NOT VERIFIED | NOT VERIFIED | `services/conversation-service`; `mlops/` |
