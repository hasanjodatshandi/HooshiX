...
| --- | --- | --- | --- | --- | --- |
| Identity Service | DESIGNED | IMPLEMENTED registration + local-password authentication/Session/RefreshFamily/JWT + Tenant/Membership/Invitation/selection repository slices | prior registration/authentication/session/JWT protected CI is VERIFIED on `main@a3766bd`; current tenant-slice local static/unit/architecture gates pass; current protected CI and deployed runtime remain NOT VERIFIED | NOT VERIFIED | `services/identity-service` |
| Authorization Service | DESIGNED | IMPLEMENTED current repository slice | local strict Gradle/unit/architecture/SpotBugs/bootJar gates pass; Testcontainers integration is NOT VERIFIED locally because Docker is unavailable; current protected CI/deployed runtime NOT VERIFIED | NOT VERIFIED | `services/authorization-service` |
...
| Web BFF | DESIGNED | IMPLEMENTED current repository slice | local strict Gradle/unit/architecture/SpotBugs/bootJar gates pass; Redis Testcontainers/protected CI/deployed edge runtime remain NOT VERIFIED | NOT VERIFIED | `services/web-bff` |
